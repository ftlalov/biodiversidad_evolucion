#!/bin/bash
#####
# script para el preproseamiento de lecturas, se requieren las lecturas
# 
#
...
export PATH="$HOME/miniconda1/bin:$PATH" 2>/dev/null
export PATH="$HOME/miniconda2/bin:$PATH" 2>/dev/null
export PATH="$HOME/miniconda3/bin:$PATH" 2>/dev/null
export PATH="$HOME/anaconda1/bin:$PATH" 2>/dev/null
export PATH="$HOME/anaconda2/bin:$PATH" 2>/dev/null
export PATH="$HOME/anaconda3/bin:$PATH" 2>/dev/null
