...
##
##
## datos de entrada.. configuración de lecturas
## datos de entrada:  archivos fastq
## datos de entrada: manifiesto con archivos fastq y su ubicación
##
...
if [ -z "$2" ]; then
    echo "Es necesario ejecutar con un archivo de muestras."
...
## Funcion de menu para declarar el tipo de metagenoma
...
### puertas logicas para el tipo de metagenoma
